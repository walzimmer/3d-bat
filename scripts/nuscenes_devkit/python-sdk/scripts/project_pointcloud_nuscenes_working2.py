...
for camera_channel in camera_channels:
    ...
    # print(-translation_vector_ego_to_cam)
    # print(rotation_matrix_ego_to_cam)
    transformation_matrix_ego_to_cam = np.zeros((4, 4))
    transformation_matrix_ego_to_cam[:3, :3] = rotation_matrix_ego_to_cam
    transformation_matrix_ego_to_cam[:3, 3] = -translation_vector_ego_to_cam
    transformation_matrix_ego_to_cam[3, 3] = 1
    print(transformation_matrix_ego_to_cam)
...
# cv2.imwrite("CAM_FRONT_000000_working3.jpg", img)
