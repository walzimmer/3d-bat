...
class NuScenes:
    ...
    def __init__(self, version: str = 'v0.1', dataroot: str = '/media/cvrr/161d15ca-26dc-4d36-b085-945b15ce24b8/sandbox/datasets/nuscenes/nuscenes_teaser_meta_v1/', verbose: bool = True):
